...
SHEEP_CAP = 8           # LIVE EXPERIMENT ONLY -- not adopted into main.py.
                        # The current rank-1 agent runs 8 cows + 8 sheep and
                        # sells 213 wool to our 68 (FINDINGS 13.10). Its full
                        # 16-animal herd measures 37/120 for us, but this
                        # reweight inside the same HERD_CAP=10 is measured
                        # NEUTRAL -- 61/120 in-sample and 64/120 out-of-sample
                        # against 60 controls on both sets. Zero measured cost,
                        # and the upside is exactly what a mirror cannot see:
                        # wool's sq x3.2 curve behaves differently against a
                        # varied field than against a clone of ourselves.
                        # Submitted alongside v17 to test that directly.
SHEEP_CAP_ORIGINAL = 4  # wool's quadratic cliff is the harshest in the game; the
