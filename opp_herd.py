...
HERD_CAP = 16           # milk is linear x1.6 and wool quadratic x3.2 above
...
SHEEP_CAP = 8           # wool's quadratic cliff is the harshest in the game; the
                        # frontier ends on 4 sheep and 9 cows every time.
ANIMAL_TILES = 18      # ceiling on the pasture reservation; the live reserve
