...
HERD_CAP = 0            # milk is linear x1.6 and wool quadratic x3.2 above
...
SHEEP_CAP = 0           # wool's quadratic cliff is the harshest in the game; the
                        # frontier ends on 4 sheep and 9 cows every time.
ANIMAL_TILES = 0       # ceiling on the pasture reservation; the live reserve
